...
namespace MoralisUnity.Samples.Shared.UnityWeb3Tools.Models
{
	...
	public class NftOwner
	{
		...
		/// example: 88256
		/// </summary>
		[DataMember(Name = "blockNumberMinted", EmitDefaultValue = false)]
		[JsonProperty(PropertyName = "blockNumberMinted")]
		...
		/// example: 0x057Ec652A4F150f7FF94f089A38008f49a0DF88e
		/// </summary>
		[DataMember(Name = "ownerOf", EmitDefaultValue = false)]
		[JsonProperty(PropertyName = "ownerOf")]
		...
		/// Last metadata sync
		/// </summary>
		[DataMember(Name = "lastMetadataSync", EmitDefaultValue = false)]
		[JsonProperty(PropertyName = "lastMetadataSync")]
		public string LastMetadataSync { get; set; }
		
		/// <summary>
		/// Last token URI sync
		/// </summary>
		[DataMember(Name = "lastTokenUriSync", EmitDefaultValue = false)]
		[JsonProperty(PropertyName = "lastTokenUriSync")]
