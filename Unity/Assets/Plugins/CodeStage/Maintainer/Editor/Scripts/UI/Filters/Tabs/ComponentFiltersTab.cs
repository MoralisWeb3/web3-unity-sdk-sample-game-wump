...
namespace CodeStage.Maintainer.UI.Filters
{
	...
	internal class ComponentFiltersTab : StringFiltersTab
	{
		...
		{
			caption = new GUIContent("Component", CSEditorIcons.Script);
		}

		protected override void DrawTabHeader()
		{
			EditorGUILayout.LabelField("Here you may specify names of Components you'd like to <b>" + 
									   CSColorTools.WrapString("include", "ignore", filterType == FilterType.Includes) + 
									   "</b> during the Issues Search.\n"+
